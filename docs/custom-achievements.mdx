...
All conditions in one achievement must be satisfied at the same time. Statistics are counted **since the player's last sleep**, not since the world was created — see [player statistics](./player-statistics).
