...
<Admonition type="info" title="Version differences">
...
| `wellRestedHudPosition` | `"left"` | Where the Rested bar sits on screen. One of `left`, `bar`, `right` — see [Well Rested](./well-rested) |
