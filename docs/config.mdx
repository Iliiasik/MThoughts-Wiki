...
The complete mod config looks like this:
...
<Admonition type="info">
    A full explanation of each parameter is located in the corresponding tab in the sidebar, including Custom Facts and Custom Achievements.
</Admonition>